    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-primary-50 via-white to-slate-100 px-4">
      <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-8 shadow-xl">
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          <p className="mt-1 text-sm text-slate-500">Smart Tuition & Student Management</p>
        </div>
        ...
        <p className="mt-6 text-center text-xs text-slate-400">
          Demo: admin@eduflow.test · teacher1@eduflow.test · student1@eduflow.test (password: password)
        </p>
      </div>
    </div>
  );
